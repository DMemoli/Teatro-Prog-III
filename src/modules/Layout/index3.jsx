...
const items = [
  ...
  getItem(<Link to="/usuarios"> Usuarios </Link>, '8', <QuestionCircleOutlined />, [
    getItem(<Link to="/usuarios/list"> Listar Usuarios</Link>, '9', <UserOutlined />),
    getItem(<Link to="/usuarios/create"> Crear Usuario</Link>, '10', <UserAddOutlined />)
  ]),
]
      ...
      <Layout style={{ width: '100%' }}>
        ...
        >
          ...
          <Tooltip title="search">
            <Button href="/login" type="primary" shape="circle" icon={<UserOutlined />} />
          </Tooltip>
        </Header>
        <Content
          style={{
